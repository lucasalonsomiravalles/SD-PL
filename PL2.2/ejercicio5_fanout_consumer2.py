...
channel.queue_declare(queue='cola_fanout2') 
channel.queue_bind(queue='cola_fanout2', exchange='probando_exchange_fanout', routing_key=routing_key)
channel.basic_consume(queue='cola_fanout2', on_message_callback=callback, auto_ack=True) 
