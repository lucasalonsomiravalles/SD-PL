...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('SQLALCHEMY_DATABASE_URI', 'mysql+pymysql://tarea_user:tarea_pass@mariadb_tarea_db/tarea_db')
db = SQLAlchemy(app)
...
def verificar(usuario, contraseña):
    ...
    if check_password_hash(autorizados[usuario],contraseña):
        return True
    else:
        return False
